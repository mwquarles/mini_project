...
describe('Service Tests', () => {
    ...
    describe('DataUploadRecord Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DataUploadRecordService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/data-upload-records/' + 123);
            });
            it('should return DataUploadRecord', () => {

                let entity: DataUploadRecord;
                service.find(123).subscribe((_entity: DataUploadRecord) => {
                    entity = _entity;
                });
